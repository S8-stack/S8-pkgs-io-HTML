...
public class Wrapping extends SSL_OutboundMode {
	...
	private SSL_OutboundMode pushing, closing, runningTasks, requestUnwrapping;
	...
	public SSL_OutboundMode run() {
		...
		try {
			...
			case NEED_TASK: return runningTasks;

			case NEED_WRAP: return this;

			case NEED_UNWRAP:
			case NEED_UNWRAP_AGAIN: 
				return requestUnwrapping;
